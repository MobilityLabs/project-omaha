...
describe 'A class that is commentable' do
  ...
  describe 'when is destroyed' do
    before :each do
      ...
      @comment = Comment.create!(commentator: @user,
  ...
  describe 'special class finders' do
    ...
    describe '#find_comments_for' do
      before :each do
        ...
        @other_comment = Comment.create!(commentator: @user,
    ...
    describe '#find_comments_by_user' do
      before :each do
        ...
        @other_comment = Comment.create!(commentator: @user2,
                                         commentable: @other_commentable,
                                         body: 'hello')

        @comments = Commentable.find_comments_by_commentator(@user)
      end
    ...
    describe '#comments_ordered_by_submitted' do
      before :each do
        ...
        @comment = Comment.create!(commentator: @user,
                                   commentable: @commentable,
                                   body: 'sup')
        @older_comment = Comment.create!(commentator: @user,
                                         commentable: @commentable,
                                         body: 'sup',
                                         created_at: 1.week.ago)
        @oldest_comment = Comment.create!(commentator: @user,
                                          commentable: @commentable,
                                          body: 'sup',
